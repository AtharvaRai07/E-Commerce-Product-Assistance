...
from prod_assistance.etl.data_scrapper import FlipkartScraper
from prod_assistance.etl.data_ingestion import DataIngestion
import os
...
if st.button("🚀 Start Scraping"):
    ...
    if not product_inputs:
        ...
        for query in product_inputs:
            ...
            results = FlipkartScraper().scrape_flipkart_products(query, max_products=max_products, review_count=review_count)
        ...
        FlipkartScraper().save_to_csv(final_data, output_path)
